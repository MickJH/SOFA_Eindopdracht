...
namespace AvansDevOps.State.Sprints.States
{
    ...
    {
        public void SetName(Sprint sprint, string name) => throw new InvalidOperationException("Cannot change the name of a sprint that is closed.");

        public void SetDates(Sprint sprint, DateTime start, DateTime end) => throw new InvalidOperationException("Cannot change the dates of a sprint that is closed.");

        public void AddBacklogItem(Sprint sprint, BacklogItem item) => throw new InvalidOperationException("Cannot add backlog items to a sprint that is closed.");
